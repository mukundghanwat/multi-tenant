 ...
 * @Date 01/08/2024
 *
 * <b>TenantDataFactory</b>
 * This is the configuration Class.
 * Configuration of multiple databases is maintained in YAML
 * and it creates Map of tenant name and its corresponding MongoClient Object with other Tenant Data.
 */
...
class TenantDataFactory {
    ...
    /**
     * <b>TenantDataFactory :: Parameterised Constructor</b>
     * This constructor will get called from MongoConfiguration at startup.
     *
    ...
    TenantDataFactory(Map<String, TenantsConfig.TenantData> tenants, String defaultTenant) {
        ...
        for (Map.Entry<String, TenantsConfig.TenantData> entry : tenants.entrySet()) {
            ...
            dataSourceBuilder.url("jdbc:mysql://" + tenantData.getHost() + ":3306/" + tenantData.getDbName() + "?enabledTLSProtocols=TLSv1.2");
            //System.out.println("DATABASE URL ::- "+"jdbc:mysql://" + tenantData.getHost()+":3306/"+tenantData.getDbName());
    ...
    /**
     * <b>getTenantData</b>
     * This method is used to get the data of a particular tenant name.
     * Whenever any request will come, it will have tenant name (database to be connected).
     * So to get the details of that database and its mongoclient object, we will use this method.
     *
