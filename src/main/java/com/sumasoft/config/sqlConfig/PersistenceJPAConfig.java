package com.sumasoft.config.sqlConfig;
...
@EnableJpaRepositories(basePackages = {"com.sumasoft.*"}, transactionManagerRef = "mySQLtransactionManager")
@EntityScan({"com.sumasoft.*"})
@ComponentScan(basePackages = "com.sumasoft.*")
public class PersistenceJPAConfig {
    ...
    public DataSource dataSource() {
        ...
        customDataSource.setDefaultTargetDataSource(tenantDataFactory.getTenantDataSource(tenantDataFactory.getDefaultTenant()));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        emfBean.setPackagesToScan(new String[]{"com.sumasoft"});
    ...
    private Map<String, Object> additionalProperties() {
        ...
        jpaProperties.put(org.hibernate.cfg.Environment.MULTI_TENANT_CONNECTION_PROVIDER, this.multiTenantConnectionProvider());
        jpaProperties.put(org.hibernate.cfg.Environment.MULTI_TENANT_IDENTIFIER_RESOLVER, this.currentTenantIdentifierResolver());
        jpaProperties.put(org.hibernate.cfg.Environment.SHOW_SQL, env.getProperty("spring.jpa.show-sql"));
        jpaProperties.put(org.hibernate.cfg.Environment.FORMAT_SQL, env.getProperty("spring.jpa.properties.hibernate.format_sql"));
        jpaProperties.put(org.hibernate.cfg.Environment.HBM2DDL_AUTO, env.getProperty("spring.jpa.hibernate.ddl-auto"));
        jpaProperties.put(org.hibernate.cfg.Environment.PHYSICAL_NAMING_STRATEGY, PhysicalNamingStrategyStandardImpl.class);
